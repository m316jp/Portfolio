...
家族の図書館管理やランニングの振り返りを作って気づいたのは、データを自動で集めるだけでは足りないということだった。自分の目標や数字に残らない事情も渡し、届いたものを自分が読める形へ使いながら直すことで、はじめて暮らしに合う道具になっていく。

家族5人分の貸出状況と返却期限を一画面にまとめた経験から、今は走行記録を自動で集め、目標と照らした振り返りが毎日届く仕組みを作っている。この記事では、家事から趣味へ広がった二つの実践を通して、AIと仕組みを作り、育てる過程を紹介する。図書館の仕組みと実際の画面は、[with classの連載記事](https://withonline.jp/with-class/education/mamacolumn/PbiTi)でも紹介している。
