...
スレッドを作ったら、[音声入力](../voice-input-for-ai-at-home/)で、そのとき頭にあることを少し話す。
...
こうして残った考えかけの会話が、もっと長い時間を経て記録になった体験は、[生成AIとの会話が、私の外部記憶になり始めた](../ai-conversations-as-external-memory/)で書いています。
